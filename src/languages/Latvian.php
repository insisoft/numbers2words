...
final class Latvian extends Language
{
	...
	public function getCurrencyNameMajor(int $amount, string $currency): string
	{
		static $names = [
			...
			Speller::CURRENCY_BRITISH_POUND      => ['mārciņa', 'mārciņas', 'mārciņas'],
			Speller::CURRENCY_LATVIAN_LAT        => ['lats', 'lati', 'lati'],
			Speller::CURRENCY_LITHUANIAN_LIT     => ['lits', 'liti', 'liti'],
			Speller::CURRENCY_RUSSIAN_ROUBLE     => ['rublis', 'rubļi', 'rubļi'],
			Speller::CURRENCY_US_DOLLAR          => ['dolārs', 'dolāri', 'dolāri'],
			Speller::CURRENCY_PL_ZLOTY           => ['zlots', 'zloti', 'zloti'],
			Speller::CURRENCY_TANZANIAN_SHILLING => ['šiliņš', 'šiliņi', 'šiliņi'],
		];
	...
	public function getCurrencyNameMinor(int $amount, string $currency): string
	{
		static $names = [
			...
			Speller::CURRENCY_BRITISH_POUND      => ['penijs', 'peniji', 'peniji'],
			Speller::CURRENCY_LATVIAN_LAT        => ['santīms', 'santīmi', 'santīmi'],
			Speller::CURRENCY_LITHUANIAN_LIT     => ['cents', 'centi', 'centi'],
			Speller::CURRENCY_RUSSIAN_ROUBLE     => ['kapeika', 'kapeikas', 'kapeikas'],
			Speller::CURRENCY_US_DOLLAR          => ['cents', 'centi', 'centi'],
			Speller::CURRENCY_PL_ZLOTY           => ['grosis', 'groši', 'groši'],
			Speller::CURRENCY_TANZANIAN_SHILLING => ['cents', 'centi', 'centi'],
		];
